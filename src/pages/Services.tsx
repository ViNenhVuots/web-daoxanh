...
export const staticAccommodations = [
  ...
  {
    name: "Nhà Thảnh Thơi",
    description: "Nhà Thảnh Thơi (Family Hotel) – Thảnh thơi nghỉ dưỡng, trọn vẹn bên nhau.",
...
export const staticComboPackages = [
  {
    ...
    includes: [
      ...
      "Hồ bơi resort",
      "Phà đưa đón qua sông, giữ xe",
      "Trà thảo mộc và nước lọc miễn phí",
      "Xe bus điện và xe đạp quanh đảo, nhân viên hướng dẫn tại các khu trải nghiệm, vui chơi và điểm tham quan",
      "Thể thao mặt nước: Chèo thuyền, chèo Súp, cầu Lắc, đu dây Zipline",
      "Hoặc Cano sinh thái tốc độ cao thưởng ngoạn sông SêRêPôk, ngã 6 sông vợ chồng và vòng quanh đảo 15 phút",
      "BBQ và lẩu tối (Bò cuộn nấm kim châm, nai nướng tảng, cá lăng nướng nghệ, rau củ nướng; lẩu gà lá é hoặc cá điêu hồng nấu mẻ thì là)"
    ],
  ...
  },
  {
    ...
    includes: [
      ...
      "Lưu trú tại nhà gỗ cao cấp Bungalow An Bình"
    ],
    img_url: ecofarmImage,
  },
];
